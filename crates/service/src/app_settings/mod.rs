...
pub use gateway::{
    ...
    current_gateway_sse_keepalive_interval_ms, current_gateway_upstream_proxy_bypass_hosts,
    ...
    set_gateway_sse_keepalive_interval_ms, set_gateway_upstream_proxy_bypass_hosts,
